  ...
  return (
    (<div
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2  gap-5">
        ...
        <div className="flex justify-center text-center item-center flex-col py-4">
          <motion.div 
            className=""
            key={active}
            initial={{
            ...
            <p className="text-md text-gray-500 dark:text-white">
              {testimonials[active].role} <span className="text-md text-gray-500 dark:text-neutral-400">
          ...
          <div className="flex gap-4 justify-center pt-4">
            <button
              ...
              <IconArrowLeft
                className="h-6 w-6 text-black dark:text-[#00d9fd] group-hover/button:rotate-12 transition-transform duration-300" />
            </button>
            <button
              onClick={handleNext}
              className="h-10 w-10 rounded-full bg-gray-100 dark:bg-neutral-800 flex items-center justify-center group/button">
